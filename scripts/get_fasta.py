...
# define directories 
csv_file_path = "/work/daylab/andrew/millerklugman.a/opt/localcolabfold/inputseq/test_seq.csv"  # Path to the CSV file containing protein names
output_directory = "/work/daylab/andrew/millerklugman.a/opt/localcolabfold/inputseq/PARP3_interactors"  # Output directory to save the FASTA files
